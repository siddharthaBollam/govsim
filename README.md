...
This project is a reproduction of the NeurIPS 2024 paper
...
59 valid runs were completed across two models, two conditions, three scenarios, and five seeds.
...
prompt. GPT-4o went from 60% to a perfect survival rate.
